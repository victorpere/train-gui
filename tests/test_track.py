...
def test_track_write_and_read(fake_factory):
    ...
    expected_message = encode_message(message_type=1, device_type=1, device_id=1, value=42)
    ...
    incoming_message = encode_message(message_type=1, device_type=0, device_id=1, value=13)
...
def test_encode_decode_message():
    ...
    # Test positive value
    msg = encode_message(message_type=1, device_type=1, device_id=1, value=42)
    ...
    # Test negative value
    msg = encode_message(message_type=1, device_type=0, device_id=1, value=-30)
    decoded = decode_message(msg)
